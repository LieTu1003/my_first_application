...
class  HomeContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
       children: <Widget>[
         everyList("任务一 完成计算机图形学作业","截至日期：2022/6/22"),
         SizedBox(height:8),
         everyList("任务二 完成数电实验作业","截至日期：2022/6/24"),
         SizedBox(height:8),
     ],
    );
  }
        ...
        children: <Widget>[
          Row(
            children:<Widget>[
              ...
              Text("任务一 计算机图形学作业",style:TextStyle(fontSize: 20,color: Colors.blue))
            ],

          ),
          SizedBox(height:8),
          Text("截至时间：2022/6/22",style:TextStyle(fontSize: 20,color: Colors.blue))
